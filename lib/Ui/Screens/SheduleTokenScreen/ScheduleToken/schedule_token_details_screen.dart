...
// import '../../../../Model/GenerateToken/generated_schedules.dart';
// import '../../../CommonWidgets/short_names_widget.dart';
...
//       int newBookLength, int newScheduleT, String newClinicName) {
//     setState(() {
//       bookLegth = newBookLength;
//       scheduleT = newScheduleT;
//       clicnicName = newClinicName;
//     });
//   }
...
//                                                     );
//                                                   log("===============log 3");
//                                               //Handle case where schedules aren't loaded
//                                                   print(
...
//                                           //   bookLegth=  model.schedules![index].bookingCount!;
//                                           // clicnicName =model.schedules![index].clinicName!;
//                                           // scheduleT =model.schedules![index].scheduleType!;
...
//   int getCurrentBookingCount(
//       String clinicId, int scheduleType, List<Schedules>? schedules) {
//     log(clinicId);
//     log(scheduleType.toString());
//     log(schedules.toString());
//     if (schedules == null) return 0;

//     var selectedSchedule = schedules.firstWhere(
//       (schedule) =>
//           schedule.clinicName == clinicId &&
//           schedule.scheduleType == scheduleType,
//       orElse: () => Schedules(bookingCount: 0),
//     );
//     log("======= tok ${selectedSchedule.bookingCount}");

//     return selectedSchedule.bookingCount ?? 0;
//   }

//   void generateToken(List<String> selectedDays) {
