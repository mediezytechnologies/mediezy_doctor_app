...
class PatientDetailsDemoWidget extends StatefulWidget {
  const PatientDetailsDemoWidget(
      {super.key,
      this.mainSymptoms,
      this.otherSymptoms,
  ...
  @override
  State<PatientDetailsDemoWidget> createState() =>
      _PatientDetailsDemoWidgetState();
}

class _PatientDetailsDemoWidgetState extends State<PatientDetailsDemoWidget> {
