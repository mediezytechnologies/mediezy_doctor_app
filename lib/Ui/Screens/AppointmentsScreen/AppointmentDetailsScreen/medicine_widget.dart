...
class _MedicineWidgetState extends State<MedicineWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      {
        if (getAllAppointmentController.loding.value) {
          Center(
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            ShortNamesWidget(
                              typeId: 1,
                              firstText: "Medicine : ",
                              secondText: widget.medicine![index].medicineName
                                  .toString(),
                            ),
                            widget.medicine![index].dosage == null
                                ...
                                : ShortNamesWidget(
                                    typeId: 1,
                                    firstText: "Dosage : ",
                                    secondText: widget.medicine![index].dosage
                                        .toString(),
                                  ),
                  ...
                  Obx(() {
                    return Row(
                      ...
                      children: [
                        checkboxCustom(
                            'Morning',
                            foodDropdownController.morningCheckedValue.value ==
                                    0
                          ...
                          child: Padding(
                            ...
                            child: Center(
                              child: DropdownButtonFormField(
                                ...
                                items: foodDropdownController.foodData
                                    .map((entry) {
                              ...
                              if (medicineNameController.text.isEmpty) {
                                ...
                                BlocProvider.of<EditMedicineBloc>(context).add(
                                  EditMedicine(
                                    ...
                                    type:
                                        foodDropdownController.foodValue.value,
                                    // passingFood,
                                ...
                                BlocProvider.of<AddPrescriptionBloc>(context)
                                    .add(
