                            ...
                            PopupMenuItem(
                              onTap: () {
                                ...
                                if (widget.bookingData != null &&
                                  ...
                                  // foodDropdownController.toggleEdit("morning",
                                  //     widget.medicine![index].morning!);

                                  // foodDropdownController.isCheckedmorning
                                  //     .value = mrngType == 1 ? true : false;
                                  // mrngStringValue = mrngType;

                                  // Update noon value based on type
                                  // String noonType =
                                  //     widget.medicine![index].noon.toString();
                                  // foodDropdownController.isCheckednoon.value =
                                  //     noonType == "1" ? true : false;
                                  ...
                                  //     .toString();
                                  // foodDropdownController.isCheckedEvening
                                  //     .value = evngType == "1" ? true : false;
                                  //    eveningStringValue = evngType;

                                  // Update morning value based on type
                                  // String nightType =
                                  //     widget.medicine![index].night.toString();
                                  // foodDropdownController.isCheckedNight.value =
