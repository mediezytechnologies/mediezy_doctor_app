                    ...
                    previousAppointmentDetailsModel
                        ...
                        : GetVitalsWidget(
                            dia: previousAppointmentDetailsModel
                                .previousappointmentdetails!.first.vitals!.dia
                                .toString(),
                            ...
                            spo2: previousAppointmentDetailsModel
                                .previousappointmentdetails!.first.vitals!.spo2
                                .toString(),
                            sys: previousAppointmentDetailsModel
                                .previousappointmentdetails!.first.vitals!.sys
                                .toString(),
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return GetMedicinesWidget(
                                medicalStore: previousAppointmentDetailsModel
                                    .previousappointmentdetails!
                                    .first
                                    .doctorMedicines![index]
                                    .medicalStoreName,
                                medicineName: previousAppointmentDetailsModel
                                    .previousappointmentdetails!
                                    .first
                                    .doctorMedicines![index]
                                    .medicineName
